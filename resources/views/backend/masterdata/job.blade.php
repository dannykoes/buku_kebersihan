                    ...
                    <table id="masterjob" class="table table-hover" style="width:100%">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <button class="btn btn-warning btn-sm" id="edit" onclick="addjob({{ $val }})"
                                    ...
                                    <button onclick="deletedata('{{ 'ajob/'.$val->id }}')" class="btn btn-danger"
                            ...
                            <div class="row">
                                ...
                                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                    <div class="form-group m-0">
                                        ...
                                        <select name="jobkantor" id="jobkantor" class="form-control"
                                            onchange="changekantor('#jobobjek','#jobkantor','#jobkantorid')">
                                            <option value="">Pilih</option>
                                ...
                                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                    <div class="form-group m-0">
                                        ...
                                        <select name="jobobjek[]" id="jobobjek" class="form-control"
                                            onchange="changegedung('#joblantai','#jobobjek','#jobkantor','#joblantaiid','select')">
                                            {{-- <option value="">Pilih</option>
