                    ...
                    <table id="masterobjek" class="table table-hover" style="width:100%">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{$val->gedung}}</td>
                                <td>{{$val->lantai}}</td>
                                <td>{{$val->ruangan . ' | '.$val->toilet.' | '.$val->outdoor}}</td>
                                ...
                                <td>
                                    <button class="btn btn-warning btn-sm" id="edit" onclick="addobjek({{ $val }})"
                                    ...
                                    <button onclick="deletedata('{{ 'aobjek/'.$val->id }}')" class="btn btn-danger"
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="aobjek" method="POST">
                            ...
                            <input type="text" name="objektoilet" id="objektoilet" hidden>
                            <input type="text" name="objekoutdoor" id="objekoutdoor" hidden>
                            <div class="row mb-2">
                                <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                                    <div class="form-group m-0">
                                        <label for="" class="text-uppercase">Kantor</label>
                                        <select name="objekkantorid[]" id="objekkantorid" class="form-control"
                                            onchange="changekantor('#objekgedungid','#objekkantorid','#objekkantor')"
                                            multiple>
                                ...
                                <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                                    <div class="form-group m-0">
                                        ...
                                        <select name="objekpekerjaan[]" id="objekpekerjaan" class="form-control"
                                            multiple>
                                            <option value="">Pilih</option>
                                ...
                                <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                                    <fieldset
                                        ...
                                        <div class="n-chk">
                                            <label
                                                class="new-control new-checkbox new-checkbox-rounded checkbox-outline-primary">
                                                <input type="radio" name="harian[]" value="1" id="harian"
                                                    class="new-control-input">
                                                <span class="new-control-indicator"></span>Harian
                                            </label>
                                            <label
                                                class="new-control new-checkbox new-checkbox-rounded checkbox-outline-primary">
                                                <input type="radio" name="harian[]" value="2" id="mingguan"
                                                    class="new-control-input">
                                                <span class="new-control-indicator"></span>Mingguan
                                            </label>
                                            <label
                                                class="new-control new-checkbox new-checkbox-rounded checkbox-outline-primary">
                                                <input type="radio" name="harian[]" value="3" id="bulanan"
                                                    class="new-control-input">
