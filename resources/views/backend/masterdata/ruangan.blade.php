                    ...
                    <table id="masterruangan" class="table table-hover" style="width:100%">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{$val->ruangan}}</td>
                                <td>
                                    <button class="btn btn-warning btn-sm" id="edit" onclick="addruangan({{ $val }})"
                                    ...
                                    <button onclick="deletedata('{{ 'aruangan/'.$val->id }}')" class="btn btn-danger"
                            ...
                            <div class="row">
                                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                    <div class="form-group m-0">
                                        ...
                                        <select name="ruangankantorid" id="ruangankantorid" class="form-control"
                                            onchange="changekantor('#ruangangedungid','#ruangankantorid','#ruangankantor')">
                                ...
                                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                    <div class="form-group m-0">
                                        ...
                                        <select name="ruangangedungid" id="ruangangedungid" class="form-control"
                                            onchange="changegedung('#ruanganlantaiid','#ruangangedungid','#ruangankantorid','#ruanganlantai','select')">
                                            <option value="">Pilih</option>
                                ...
                                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="ruangannama" id="ruangannama" class="form-control"
                                            required>
                                    </div>
                                    @error('ruangannama')
                                    <small class="text-danger">{{$message}}</small>
