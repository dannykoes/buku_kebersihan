    ...
    <div class="widget-content">
        <div class="row p-3">
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 layout-spacing">
                <button class="btn btn-primary btn-sm" id="add" onclick="addgedung()" title="Tambah">
                ...
                <div class="table-repsonsive">
                    <table id="mastergedung" class="table table-hover" style="width:100%">
                        <thead>
                            <tr>
                                <th>No</th>
                                <th>Kantor</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <button onclick="deletedata('{{ 'agedung/'.$val->id }}')" class="btn btn-danger" title="Delete"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" style="fill: rgba(255, 255, 255, 1);">
        ...
        <!-- Modal -->
        <div class="modal fade" id="modalgedung" role="dialog" aria-labelledby="modalgedungLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="modalgedungLabel">Gedung</h5>
                        <button type="button" class="btn btn-secondary" onclick="closemodal('#modalgedung')">
                    ...
                    <div class="modal-body">
                        <form action="agedung" method="POST">
                            @csrf
                            <input type="text" name="gedungid" id="gedungid" hidden>
                            <div class="row">
                                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                    <div class="form-group m-0">
                                        <label for="" class="text-uppercase">Gedung</label>
                                        <select name="gedungkantorid" id="gedungkantorid" class="form-control">
                                ...
                                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="gedungnama" id="gedungnama" class="form-control" required>
                                    </div>
                                    @error('gedungnama')
                                        <small class="text-danger">{{$message}}</small>
                                    @enderror
