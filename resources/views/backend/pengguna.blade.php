<div class="widget widget-chart-two">
    <div class="widget-content">
        <form action="pengguna" method="POST">
            ...
            <span class="btn btn-warning btn-sm m-2" onclick="resetpengguna()"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" style="fill: rgba(255, 255, 255, 1);transform: ;msFilter:;">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <button class="btn btn-danger" onclick="deletedata('{{ 'pengguna/'.$k->id }}')" title="Delete"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" style="fill: rgba(255, 255, 255, 1);transform: ;msFilter:;">
