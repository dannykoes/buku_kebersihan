<div class="widget widget-chart-two">
    <div class="widget-content">
        <form action="lantai" method="POST">
            ...
            <span class="btn btn-warning btn-sm m-2" onclick="resetlantai()"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" style="fill: rgba(255, 255, 255, 1);transform: ;msFilter:;">
                    ...
                    <table id="masterlantai" class="table table-hover" style="width:100%">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{$k->lantai}}</td>
                                <td>
                                    <button class="btn btn-warning" id="edit" onclick="editlantai({{ $k }})" title="Edit"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" style="fill: rgba(255, 255, 255, 1);transform: ;msFilter:;">
                                            <path d="m16 2.012 3 3L16.713 7.3l-3-3zM4 14v3h3l8.299-8.287-3-3zm0 6h16v2H4z"></path>
                                        </svg></button>
                                    <button class="btn btn-danger" onclick="deletedata('{{ 'lantai/'.$k->id }}')" title="Delete"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" style="fill: rgba(255, 255, 255, 1);transform: ;msFilter:;">
