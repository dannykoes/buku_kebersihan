    ...
    <div class="widget-content">
        <form action="kantor" method="POST">
            ...
            <div class="form-group m-2">
                ...
                <input type="text" name="namakantor" id="namakantor" value="{{old('namakantor')}}" class="form-control">
                @error('namakantor')
            ...
            <span class="btn btn-warning btn-sm m-2" onclick="resetkantor()"><svg xmlns="http://www.w3.org/2000/svg"
        ...
        <table id="masterkantor" class="table table-hover" style="width:100%">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>{{$k->nama}}</td>
                    <td>
                        <button class="btn btn-warning" id="edit" onclick="editkantor({{ $k }})" title="Edit"><svg
                                xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                style="fill: rgba(255, 255, 255, 1);transform: ;msFilter:;">
                                <path d="m16 2.012 3 3L16.713 7.3l-3-3zM4 14v3h3l8.299-8.287-3-3zm0 6h16v2H4z"></path>
                            </svg></button>
                        <button class="btn btn-danger" onclick="deletedata('{{ 'kantor/'.$k->id }}')"
